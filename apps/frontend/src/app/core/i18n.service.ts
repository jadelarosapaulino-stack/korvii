...
const EN_DICTIONARY_NORMALIZED = new Map(
  Object.entries(EN_DICTIONARY).map(([key, translation]) => [normalizeLookupKey(key), translation]),
);
...
export class I18nService {
  ...
  translate(value: string | null | undefined): string {
    ...
    const exact = EN_DICTIONARY[trimmed]
      ?? EN_DICTIONARY_NORMALIZED.get(normalizeLookupKey(trimmed));
